const Home = () => {
    return (
        <div className="flex flex-col items-start gap-2">
            ...
            <div className="w-[300px] bg-zinc-900 rounded-md flex flex-col items-start">
            ...
            <div className="w-[300px] gap-2 pt-2 bg-zinc-900 rounded-md flex flex-col items-start">
                ...
                <div className="flex flex-col items-start w-[300px] gap-2">
                    ...
                    <div className="flex flex-row justify-evenly w-[300px] pb-3">
